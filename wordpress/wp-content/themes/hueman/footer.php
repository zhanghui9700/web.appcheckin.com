			...
			<div class="container-inner">
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="credit">
							<p><?php _e('Proudly Powered by','hueman'); ?> <a href="http://www.appcheckin.com" rel="nofollow">AppCheckin</a>. <?php _e('Contact by','hueman'); ?> <a href="mailto:appcheckin(#)gmail.com" rel="nofollow">Mail</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
